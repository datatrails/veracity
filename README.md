...
Veracity provides native binaries for [Mac OS](#mac-install) and [Linux](#linuxwsl-install) on the [releases](https://github.com/datatrails/veracity/releases) page.
